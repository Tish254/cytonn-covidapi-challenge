...
const CovidHistory = () => {
  ...
  const onSearchHandler = (value) => {
    if (value) setSearchHistory( prev =>({...prev, country: value.toLowerCase()}));
  };

  return (
    <div className="flex-col section">
      <div className="flex-row">
      <DatePicker onChange={onChange} className="app-date-picker" defaultValue={dayjs(dayjs(), 'YYYY-MM-DD')}/>
          <Search
